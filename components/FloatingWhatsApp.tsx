...
export function WhatsAppButton() {
  const phoneNumber = '9343430401';
  const message = 'Hello Zippy Solar, I would like to know more about your services.';
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[9999] flex items-center justify-center bg-zippy-green text-white rounded-full shadow-2xl w-[52px] h-[52px] md:w-[60px] md:h-[60px]"
